        ...
        <section className="about-us wrapper">
            <article className="intro proba">
                <div className="text">
                    ...
                    <h4 className="text-center">Renax har sedan 1993 samlat erfarenhet, certifikat och kompetens inom alla områden som avser
            ...
            <article className="section-first container">
                ...
                <div className="about-text">
                    ...
                    <p>Vårt starka fokus är i våra kundrelationer, där vi arbetar långsiktigt och med fokus att en kund
                        ska vara kund så länge dem har behovet av en städfirma, något som har varit otroligt lönsamt för
                        oss. Organisationen har utvecklats och skalats i samband med behoven som presenterat sig och
                        våra anställda är välutbildade och vi har lyckats skapa en arbetsmiljö där anställda stannar i
                        flera år.</p>
                </div>
            </article>
            <article className="section-first container">
                <div className="about-text">
                    ...
                    <p>Nöjda kunder och nöjd personal går hand i hand
                        ...
                        Renax AB sysselsätter idag över 100 anställda, med kontor i Helsingborg, XXX, XXX, XX och vår
                        organisation är utvecklad för att kunna hantera kunder i hela Sverige.

                        Vi är en aktiv affärsorienterad verksamhet, ständigt utvecklande och anpassad efter kundens och
                        branschens krav. Den högsta kvalitén är det enda vi nöjer oss med och våra referenser talar väl
                        för oss.</p>
                </div>
